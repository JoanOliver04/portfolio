...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "web",
    repoType: "source",
    github: "https://github.com/JoanOliver04/planora",
    liveUrl: "https://planora-lake-one.vercel.app/en",
    badge: { en: "Live product", es: "Producto online" },
    tech: ["Next.js 16", "React 19", "TypeScript", "Supabase", "PostgreSQL", "PWA", "Playwright", "Zod"],
    images: [
    ...
    tagline: {
      en: "A calm, deeply personalizable planner for routines that keep changing.",
      es: "Un planificador tranquilo y muy personalizable para rutinas que no dejan de cambiar.",
    },
    problem: {
      en: "Most planners assume every week looks the same. Real life mixes studies, work, habits and personal commitments, so rigid systems quickly become another thing to maintain.",
      es: "La mayoría de planificadores asumen que todas las semanas son iguales. La vida real mezcla estudios, trabajo, hábitos y compromisos personales, y los sistemas rígidos terminan siendo otra carga más.",
    },
    product: {
      en: "Planora combines tasks, habits, schedules, events, reminders and progress in one bilingual workspace. It supports multiple contexts, works offline, syncs securely through Supabase and includes a complete public demo with isolated sample data.",
      es: "Planora reúne tareas, hábitos, horarios, eventos, recordatorios y progreso en un espacio bilingüe. Admite múltiples contextos, funciona offline, sincroniza de forma segura con Supabase e incluye una demo pública completa con datos aislados.",
    },
    highlights: {
      en: [
        "Timezone-safe recurrence engine for daily, weekday, interval and target-per-week habits.",
        "Offline-first PWA with queued mutations, conflict handling and visible sync state.",
        "Deep personalization across color, density, typography, motion, week layout and day parts.",
        "Privacy-focused architecture: Google OAuth, Supabase RLS, portable backups and optional cookie-free analytics.",
        "Production discipline with 65 unit/component tests, 16 browser scenarios, CI and automated accessibility checks.",
        "Public no-registration demo that keeps sample data isolated in the browser.",
      ],
      es: [
        "Motor de recurrencia seguro por zona horaria para hábitos diarios, semanales, por intervalo y objetivo semanal.",
        "PWA offline-first con mutaciones en cola, gestión de conflictos y estado de sincronización visible.",
        "Personalización profunda de color, densidad, tipografía, movimiento, semana y franjas del día.",
        "Arquitectura centrada en privacidad: Google OAuth, RLS de Supabase, copias portables y analítica opcional sin cookies.",
        "Disciplina de producción con 65 tests unitarios/de componentes, 16 escenarios de navegador, CI y accesibilidad automatizada.",
        "Demo pública sin registro con datos de muestra aislados en el navegador.",
      ],
    },
    metrics: [
      { en: "65 unit & component tests", es: "65 tests unitarios y de componentes" },
      { en: "16 desktop & mobile E2E", es: "16 E2E en escritorio y móvil" },
      { en: "97 Lighthouse performance", es: "97 de rendimiento Lighthouse" },
      { en: "100 accessibility · SEO", es: "100 accesibilidad · SEO" },
    ],
  },
  {
    id: "fitprompt",
  ...
  },
  {
    ...
    images: [
      {
        ...
        caption: { en: "The hub — 29 mini-games, one scoreboard", es: "El hub — 29 minijuegos, un marcador" },
      },
      {
    ...
    tagline: {
      en: "Twenty-nine browser mini-games, most with an algorithmic AI opponent — and 28 playable live against a friend.",
      es: "Veintinueve minijuegos de navegador, la mayoría con una IA algorítmica — y 28 jugables en directo contra un amigo.",
    },
    problem: {
    ...
    product: {
      en: "One bilingual hub over 29 solo games — from minimax and Monte Carlo tree search to XOR nim-sum game theory, A* pathfinding, exact card counting, meld evaluation, blocking dominoes and a solvable sliding puzzle. 28 games also run as live multiplayer rooms: a friend joins with a short code and you play head-to-head, backed by a thin Firebase layer with no server of the project's own.",
      es: "Un hub bilingüe sobre 29 juegos en solitario — desde minimax y Monte Carlo tree search hasta teoría de juegos con nim-sum (XOR), pathfinding A*, conteo exacto de cartas, evaluación de combinaciones, dominó de bloqueo y rompecabezas deslizante resoluble. 28 juegos funcionan además como salas multijugador en directo: un amigo entra con un código corto y jugáis cara a cara, apoyado en una fina capa de Firebase sin servidor propio.",
    },
    highlights: {
      en: [
        ...
        "Live multiplayer for 28 games via a game-agnostic Cloud Firestore room layer covering five sync patterns (turn-based, simultaneous-move, lockstep, shared-seed score-attack and live-synced duel) — with zero server compute, on Firebase's free Spark plan.",
        ...
        "Structured move histories are rendered through the active locale, so gameplay logs switch between English and Spanish while branded board spaces stay unchanged.",
      ...
      es: [
        ...
        "Multijugador en directo para 28 juegos mediante una capa de salas en Cloud Firestore agnóstica al juego, con cinco patrones de sincronización (por turnos, movimiento simultáneo, lockstep, score-attack con semilla compartida y duelo sincronizado en vivo) — sin cómputo en servidor, en el plan gratuito Spark de Firebase.",
        ...
        "Los historiales de movimientos estructurados se renderizan con el idioma activo, así los logs cambian entre inglés y español mientras las casillas de marca permanecen igual.",
    ...
    metrics: [
      { en: "29 mini-games", es: "29 minijuegos" },
      { en: "28 live multiplayer", es: "28 con multijugador" },
